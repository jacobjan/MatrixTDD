...
public class MatrixOpsActivity extends AppCompatActivity {
    ...
    public String showMe = "whoAmi";
    public String showAction = "Calling Activity class name :";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, showMe, Snackbar.LENGTH_LONG)
                        .setAction(showAction, null).show();
            }
        });
    }
